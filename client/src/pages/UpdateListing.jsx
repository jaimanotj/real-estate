      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        <div className="flex flex-col gap-4 flex-1 ">
          <input
            type="text"
            placeholder="Name"
            className="border-bgColorLight p-3 rounded-lg"
            id="name"
            maxLength="62"
            minLength="10"
            required
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold">
            Images:
            <span className="font-normal text-slate ml-2">
          ...
          <div className="flex gap-4">
            <input
              ...
              className="border-bgColorLight p-3 border rounded w-full focus:outline-none"
              type="file"
              id="images"
              accept="image/*"
              multiple
            ...
            <button
              ...
              type="button"
              disabled={uploading}
              className="p-3 text-green border border-green rounded hover:shadow-lg disabled:opacity-80"
            >
              {uploading ? "VIEWING..." : "PREVIEW"}
            </button>
          </div>
